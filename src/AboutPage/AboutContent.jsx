...
const aboutInfo = {
    aboutText: [
        "Claes och Max är två killar i övre tjugoårsåldern som har spelat musik tillsammans i olika konstallationer sedan tio år tillbaka. Som duo har de turnerat gatorna i södra Europa ett par somrar, men framförallt har man kunnat se dem på gatorna i Uppsala och Stockholm eller på något av de många event de blivit anlitade för.",
        ...
        "Claes&Max är tillgängliga för spelningar på diverse event och tar gärna emot erbjudanden. De kan fakturera med F-skatt - inga krångligheter!"
    ]
}
